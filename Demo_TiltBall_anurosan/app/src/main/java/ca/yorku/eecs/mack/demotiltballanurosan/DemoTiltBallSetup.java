...
public class DemoTiltBallSetup extends Activity 
{
	...
	Spinner spinOrderOfControl, spinGain, spinPathMode, spinPathWidth, spinNum;
	...
	public void clickOK(View view) 
	{
		...
		int numOfLaps = NUMBER_OF_LAPS[spinNum.getSelectedItemPosition()];
		...
		b.putInt("numOfLaps", numOfLaps);

		// start experiment activity
		Intent i = new Intent(getApplicationContext(), DemoTiltBallanurosanActivity.class);
		i.putExtras(b);
		startActivity(i);
